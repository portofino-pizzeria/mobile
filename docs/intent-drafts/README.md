...
| `domain_spec--imagery-and-iconography--APPEND-3.md` | `domain_spec/imagery-and-iconography` | append (second icon set, Antipasti Misto removed), **pending** — needs a pizzeria credential |
